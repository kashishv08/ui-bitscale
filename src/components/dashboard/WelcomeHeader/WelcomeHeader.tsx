...
const WelcomeHeader = ({
  ...
  <div className="flex flex-col md:flex-row items-start md:items-center justify-between px-4 md:px-6 pt-5 pb-4 gap-4">
    {}
    <div>
      <h1 className="text-lg md:text-lg font-semibold text-gray-900" style={{ lineHeight: '1.2' }}>
    ...
    <div className="flex flex-wrap items-center gap-2 mt-1 w-full md:w-auto">
      <button
        ...
        className="flex-1 md:flex-none justify-center flex items-center gap-2 text-[11px] font-medium text-[#1e293b] border border-[#e2e8f0] rounded-[10px] px-4 py-2 hover:bg-gray-50 transition-colors whitespace-nowrap bg-white shadow-sm"
      >
